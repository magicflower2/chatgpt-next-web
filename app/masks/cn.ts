...
export const CN_MASKS: BuiltinMask[] = [
    ...
    context: [
      {
        id: "lw-writer-0",
        role: "system",
        content: "润色下面的内容，使其更加更合逻辑，更符合学术风格： ",
        date: "",
      },
    ],
    modelConfig: {
  ...
  {
    avatar: "1f5bc-fe0f",
    name: "简易论文生成器（请输入主题或题目即可）-lw",
    context: [
      {
        id: "lw-writer-0",
        role: "system",
        content:
          "Write a highly detailed essay in Chinese with introduction, body, and conclusion paragraphs responding to the following: ",
        date: "",
      },
    ],
    modelConfig: {
